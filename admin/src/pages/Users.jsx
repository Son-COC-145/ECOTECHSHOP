      ...
      <div className="admin-dashboard-layout">
        ...
        {loading && users.length === 0 ? (
          ...
          <>
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 16, justifyContent: "center", flexWrap: "wrap", padding: 12,}}>
              ...
              <span style={{ marginLeft: 8, fontSize: 14, color: "#666" }}>
                Trang {page} / {totalPages} • Tổng {Number(total || 0).toLocaleString("vi-VN")} người dùng
              </span>
            </div>
          </>
        )}
